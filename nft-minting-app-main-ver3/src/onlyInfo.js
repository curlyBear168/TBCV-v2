      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg alt={"example"} src={"/config/images/ezgif.com-gif-maker.gif"}/>
      ...
      no need button here
        ...
        <s.Container
          ...
          <s.TextTitle
            ...
            >
              BV Dating Club is essentially a blockchain-based social dating community 
              that offers key elements missing from current dating app, like trust, transparency, data security and fraud protection against nefarious actors, or ‘catfishes.
            </s.TextTitle>  
           <s.SpacerXXSmall/>
            <s.TextTitle
              style={{
            ...
            >
              By owning a Bored Valentines Club NFT, 
              you gain accesss to the Dating Club where you can meet other like-minded Valentines.
            </s.TextTitle>  
        </s.Container>
        <s.SpacerMedium />    
        <s.Container
